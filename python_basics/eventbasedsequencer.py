...
while (not correctInput):
    try:
        timestamp_input = int(input("Give timestamps for hihat:"))
...
while (not correctInput):
    try:
        timestamp_input = int(input("Give timestamps for snare:"))
...
while (not correctInput):
    try:
        timestamp_input = int(input("Give timestamps for kick:"))
